...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyDd7UUF_-MamhPwTa6YCSGxs-C87rxoNpc",
  authDomain:
    process.env.REACT_APP_FIREBASE_AUTH_DOMAIN ||
    "ai-edu-project-4e9b9.firebaseapp.com",
  projectId:
    process.env.REACT_APP_FIREBASE_PROJECT_ID || "ai-edu-project-4e9b9",
  storageBucket:
    process.env.REACT_APP_FIREBASE_STORAGE_BUCKET ||
    "ai-edu-project-4e9b9.firebasestorage.app",
  messagingSenderId:
    process.env.REACT_APP_FIREBASE_MESSAGING_SENDER_ID || "812726253621",
  appId:
    process.env.REACT_APP_FIREBASE_APP_ID ||
    "1:812726253621:web:fe83d1c67a6758931c997c",
};
