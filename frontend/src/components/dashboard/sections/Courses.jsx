          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => onOpenCourse?.(c.title)}
                  className="text-blue-600 dark:text-blue-300 hover:text-blue-700 dark:hover:text-blue-200 text-sm font-medium"
                >
                  Ver curso
                </button>
                <button
                  ...
                  title={
                    c.progress < 100
                      ? "Completa el curso para obtener el certificado"
                      : "Descargar certificado"
                  }
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium border border-gray-300 dark:border-slate-700 ${c.progress < 100 ? "opacity-50 cursor-not-allowed" : ""}`}
                >
                  Certificado
                </button>
              </div>
