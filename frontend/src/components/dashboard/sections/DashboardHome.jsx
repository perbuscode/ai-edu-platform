...
export default function DashboardHome({
  ...
  stats = { completed: "3/5", hours: "127h", certificates: "2" },
  upcoming = [
  ...
  materials = [
    { tag: "PDF", color: "text-red-600", bg: "bg-red-100", name: "Guía JavaScript", info: "2.3 MB" },
    { tag: "ZIP", color: "text-blue-600", bg: "bg-blue-100", name: "Ejercicios Prácticos", info: "5.7 MB" },
    { tag: "MP4", color: "text-green-600", bg: "bg-green-100", name: "Video Tutorial", info: "45 min" },
  ],
  activity = [
    { iconBg: "bg-green-100", iconColor: "text-green-600", text: "Completaste la lección \"Promesas en JavaScript\"", time: "Hace 2 horas" },
    { iconBg: "bg-blue-100", iconColor: "text-blue-600", text: "Descargaste el material \"Ejercicios de Async/Await\"", time: "Ayer" },
    { iconBg: "bg-purple-100", iconColor: "text-purple-600", text: "Obtuviste una calificación de 95% en el quiz", time: "Hace 3 días" },
  ],
  onContinue,
}) {
  return (
      ...
      <section>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-6">
          <div className="flex items-start justify-between">
            ...
            <button onClick={onContinue} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
              Continuar Clase
            </button>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {activity.map((a, i) => (
            <div key={i} className="flex items-start space-x-4">
              <div className={`w-10 h-10 ${a.iconBg} rounded-full flex items-center justify-center flex-shrink-0`}>
                <svg className={`w-5 h-5 ${a.iconColor}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
