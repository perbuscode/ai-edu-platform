            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <article className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-6 lg:col-span-2">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                  <li className="border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2">
                    ⏱️ Horas restantes: <span className="font-medium">—</span>
                  </li>
                  <li className="border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2">
                    📚 Lección actual: <span className="font-medium">—</span>
                  </li>
                  <li className="border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2">
                    📅 Próxima clase: <span className="font-medium">—</span>
                  </li>
                  <li className="border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2">
                    🏁 ETA final: <span className="font-medium">—</span>
                  </li>
                </ul>
              </article>
            </div>
              ...
              <div className="flex items-center gap-3 mb-6">
                {[1, 2, 3].map((i) => (
                  <React.Fragment key={i}>
                    <div
                      className={`w-6 h-6 rounded-full grid place-items-center ${step === i ? "text-white bg-blue-600" : "text-gray-600 bg-gray-200 dark:bg-slate-800 dark:text-slate-300"}`}
                    >
                      {i}
                    </div>
                    {i < 3 && (
              ...
              {step === 2 && (
                <div>
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    <button
                      onClick={() => setStep(1)}
                      className="border border-gray-200 dark:border-slate-700 px-4 py-2 rounded-lg text-sm"
                    >
                      Volver al video
                    </button>
                    <button
                ...
                <div>
                  ...
                  <div className="border border-dashed border-gray-300 dark:border-slate-700 rounded-lg p-4">
                    ...
                    <textarea
                      ...
                      rows="5"
                      placeholder="Escribe aquí tu solución, los pasos que seguiste o una reflexión..."
                    ></textarea>
                  </div>
                  <div className="mt-4 flex items-center gap-2">
                    <button
          ...
          <section id="tab-studyplan">
            <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-6">
              ...
              <ol className="space-y-3">
                <li className="flex items-center justify-between border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2">
                  <span>1. Introducción al curso</span>
