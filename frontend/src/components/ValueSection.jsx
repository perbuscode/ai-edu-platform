...
export default function ValueSection() {
  ...
  const icons = [
    (
      <svg key="i1" viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
        <path fill="currentColor" d="M12 2a10 10 0 100 20 10 10 0 000-20Zm1 5v6h5v2h-7V7h2Z" />
      </svg>
    ),
    (
      <svg key="i2" viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
        <path fill="currentColor" d="M3 5h18v2H3V5Zm2 4h14v10H5V9Zm2 2v6h10v-6H7Z" />
      </svg>
    ),
    (
      <svg key="i3" viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
        <path fill="currentColor" d="M12 12a5 5 0 100-10 5 5 0 000 10ZM2 20a8 8 0 0116 0v2H2v-2Z" />
      </svg>
    ),
    (
      <svg key="i4" viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
        <path fill="currentColor" d="M4 4h16v4H4V4Zm0 6h10v4H4v-4Zm0 6h7v4H4v-4Z" />
      </svg>
    ),
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {items.map((it, i) => (
            ...
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" style={{background:"radial-gradient(120px 60px at 20% 0%, rgba(14,165,233,0.10), transparent 60%), radial-gradient(120px 60px at 80% 0%, rgba(99,102,241,0.10), transparent 60%)"}} />
              ...
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-semibold text-slate-900 text-[15px]">{it.title}</h3>
              </div>
