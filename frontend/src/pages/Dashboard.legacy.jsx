      ...
      const applyFix = (root) => {
        ...
        for (const node of nodes) {
          ...
          for (const [badEsc, goodEsc] of pairs) {
            ...
            const good = goodEsc.replace(/\\u00([0-9A-Fa-f]{2})/g, (_, h) =>
    ...
    try {
      ...
      for (const node of nodes) {
        ...
        for (const [bad, good] of replacements) {
          ...
          if (t.includes(badReal)) {
            t = t.split(badReal).join(good);
            changed = true;
          }
        }
        if (changed) node.nodeValue = t;
  ...
  return (
    <div className="bg-gray-50 text-gray-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <div
        ...
        className={appClass}
        onClick={
          mobile && sidebarMode === "expanded" ? collapseSidebar : undefined
        }
      >
        <header
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-slate-400">
                        {c.id === "frontend"
                          ? "Módulo 3: JS Avanzado"
                          : "Nivel: Básico â€“ Avanzado"}
                      </p>
                    </div>
                  </div>
                  <div className="mb-3">
                ...
                {step === 2 && (
                  <div id="class-step-2">
                    ...
                    <div className="prose max-w-none text-gray-800 dark:text-slate-200">
                      <p>
                        En esta lección profundizamos en{" "}
                        <strong>conceptos clave</strong> y buenas prácticas.
                      </p>
                    </div>
                  ...
                  <div id="class-step-3">
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          alert(
                            "¡Clase marcada como completada! Avanzarás a la siguiente cuando esté disponible."
                          );
                          setStep(1);
                        }}
