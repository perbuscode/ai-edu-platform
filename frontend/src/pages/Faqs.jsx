...
const QAS = [
  ...
  { q: "¿Qué nivel necesito para empezar?", a: "Desde cero hasta avanzado: ajustamos ritmo y materiales a tu punto de partida." },
  { q: "¿Hay garantía?", a: "Si no te resulta útil en la primera semana, te ayudamos a reencaminar o devolvemos tu dinero (7 días)." },
  { q: "¿Necesito una computadora potente?", a: "No. Con navegador moderno es suficiente para la mayoría de actividades." },
  { q: "¿Puedo pausar y retomar luego?", a: "Sí, puedes pausar y reagendar. Guardamos tu progreso y siguientes pasos." },
  { q: "¿Cómo se evalúa mi progreso?", a: "Usamos rúbricas claras, revisiones semanales y proyectos con entregables verificables." },
  { q: "¿Incluye comunidad y soporte?", a: "Sí, acceso a comunidad privada, sesiones grupales y soporte por chat." },
  { q: "¿Puedo combinar cursos?", a: "Sí, armamos un plan que combine habilidades según tu objetivo (ej. datos + presentación)." },
];
          ...
          {QAS.map((qa, i) => (
            <details key={i} className="group p-4">
              <summary className="cursor-pointer select-none list-none font-medium text-slate-900 flex items-center justify-between rounded-md focus-visible:ring-2 focus-visible:ring-sky-500">
                <span>{qa.q}</span>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true" className="ml-3 text-slate-400 transition-transform duration-200 group-open:rotate-180 group-open:text-sky-600"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
              </summary>
