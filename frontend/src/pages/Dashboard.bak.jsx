      ...
      {sidebarMode !== 'hidden' && (
        <aside id="sidebar" className={`fixed inset-y-0 left-0 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 z-40 ${sidebarMode === 'collapsed' ? 'collapsed' : 'expanded'}`} aria-label="Navegación del curso" aria-hidden={sidebarMode === 'hidden'}>
          <div id="sidebar-header" className="p-3 border-b border-gray-200 dark:border-slate-800 flex items-center justify-between">
            <button id="showNavBtn" onClick={expandSidebar} className={`${sidebarMode === 'collapsed' ? '' : 'hidden'} p-1.5 rounded-md border border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800`} aria-label="Mostrar navegaciÃ³n">
            ...
            <button id="hideSidebar" onClick={collapseSidebar} className={`${sidebarMode === 'collapsed' ? 'hidden' : ''} p-1.5 rounded-md border border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-800`} aria-label="Ocultar navegaciÃ³n">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"/></svg>
            </button>
          </div>
          <nav id="sidebar-content" className="mt-3 p-2" role="tablist" aria-orientation="vertical">
            <p id="sidebar-label" className={`${sidebarMode === 'collapsed' ? 'hidden' : ''} px-4 pb-2 text-xs font-semibold text-gray-400 uppercase tracking-wider`}>NavegaciÃ³n</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <article className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-xl p-6 lg:col-span-2">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    ...
                    <li className="border chip dark:border-slate-700 rounded-lg px-3 py-2">{'\uD83D\uDCDA'} Lección actual: <span id="ov-lesson" className="font-medium">â€”</span></li>
                    <li className="border chip dark:border-slate-700 rounded-lg px-3 py-2">{'\uD83D\uDD52'} Próxima clase: <span id="ov-next" className="font-medium">â€”</span></li>
                    <li className="border chip dark:border-slate-700 rounded-lg px-3 py-2">{'\u23F1\uFE0F'} Hora estimada de llegada: <span id="ov-eta" className="font-medium">â€”</span></li>
                  </ul>
                </article>
              </div>
            </section>
